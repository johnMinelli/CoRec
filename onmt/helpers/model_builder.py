...
def build_embeddings(opt, word_dict, feature_dicts, for_encoder=True):
    ...
    feats_padding_idx = [feat_dict.stoi[inputters.PAD_WORD] for feat_dict in feature_dicts]
...
def build_model(model_opt, vocab, gpu, checkpoint=None):
    ...
    src_embeddings = Embeddings(word_vec_size=model_opt.src_word_vec_size,
                                ...
                                word_padding_idx=src_dict[inputters.PAD_WORD],
    ...
    tgt_embeddings = Embeddings(word_vec_size=model_opt.tgt_word_vec_size,
                                ...
                                word_padding_idx=tgt_dict[inputters.PAD_WORD],
                                position_encoding=model_opt.position_encoding,
                                dropout=model_opt.dropout,
                                sparse=model_opt.optim == "sparseadam")
    ...
    if not model_opt.copy_attn:
        ...
        generator = nn.Sequential(nn.Linear(model_opt.dec_rnn_size, tgt_dict), gen_func)
